...
public class Day3 {
    ...
    void calibrationTest() {
        ...
        int sumOfEngineParts = game.calculateSumOfEngineParts();
        int calculateGearRatios = game.calculateGearRatios();

        Assertions.assertThat(sumOfEngineParts).isEqualTo(4361);
        Assertions.assertThat(calculateGearRatios).isEqualTo(467835);
    }
    ...
    void actualInput() {
        ...
        Game game = new Game(input);
        int result = game.calculateSumOfEngineParts();
        int calculateGearRatios = game.calculateGearRatios();


        Assertions.assertThat(result).isEqualTo(539637);
        Assertions.assertThat(calculateGearRatios).isEqualTo(82818007);
    }
}
